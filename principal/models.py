...
class ReciboVehiculos(models.Model):
	...
	recibo_no = models.CharField(max_length=100, blank=True, null=True)
	cliente = models.ForeignKey(Cliente,on_delete=models.CASCADE)
	num_pasaporte = models.CharField(max_length=50, blank=True, null=True)
	correo = models.EmailField(blank=True, null=True)
	telefono_adicional = models.CharField(max_length=15, blank=True, null=True)
	pais_destino = models.CharField(max_length=15, blank=True, null=True)
	puerto_destino = models.CharField(max_length=15, blank=True, null=True)
	...
	vin_vehiculo = models.CharField(max_length=17, blank=True, null=True)
	valor_vehiculo =  models.FloatField(blank=True, null=True)
	direccion_recibe = models.CharField(max_length=150, blank=True, null=True)
	valor_documentacion = models.FloatField(blank=True, null=True)
	usuario_registro = models.ForeignKey(User,on_delete=models.CASCADE)
	fecha = models.DateField(auto_now_add=True)
	cierre = models.BooleanField(default=False) #False sin cierre / True Cerrado
	fecha_cierre = models.DateField(auto_now_add=True)
	seguro = models.FloatField(blank=True, null=True)
	valor_asegurado = models.FloatField(blank=True, null=True)
	color_vehiculo = models.CharField(max_length=50, blank=True, null=True)
	valor_envio_vehiculo = models.FloatField(blank=True, null=True)
