...
class Empleado(models.Model):
    ...
    usuario =  models.ForeignKey(User,related_name='empleado_usuario')
    rol_empleado =  models.ForeignKey(Rol)
    usuario_registro = models.ForeignKey(User,related_name='empleado_usuario_registro')
...
class Empresa(models.Model):
    ...
    usuario_registro = models.ForeignKey(User,related_name='empresa_usuario_registro')
    def __str__(self):
...
class Revendedor(models.Model):
	...
	usuario_registro = models.ForeignKey(User,related_name='usuario_registro_revendedor', default= 1)
	def __str__(self):
		return '{0}'.format(self.nombre_empresa)

class EmpresaDiaContable(models.Model):
    codigo_empresa = models.ForeignKey(Empresa, blank=True, null=True)
    ...
    usuario_registro = models.ForeignKey(User,related_name='empresa_dia_usuario_registro')
    def __str__(self):
...
class EmpresaEmpleado(models.Model):
    ...
    usuario_registro = models.ForeignKey(User,related_name='empresa_empleado_usuario_registro')
    def __str__(self):
...
class Cliente(models.Model):
	...
	usuario_registro = models.ForeignKey(User,related_name='usuario_registro')
	...
	revenedor_creo = models.ForeignKey(Revendedor, null=True)
...
class ClienteRecibe(models.Model):
	cliente_envia = models.ForeignKey(Cliente)
	nombre_completo = models.CharField(max_length=100, blank=False, null=False)
	...
	usuario_registro = models.ForeignKey(User,related_name='cliente_recibe_usuario_registro')
	pais_pk = models.ForeignKey(Pais, blank=True, null=True)
	departamento_pk = models.ForeignKey(Departamento, blank=True, null=True)
...
class EmpresaControlCaja(models.Model):
	...
	usuario_registro = models.ForeignKey(User,related_name='empresa_caja_usuario_registro')
	def __str__(self):
...
class EmpresaActividades(models.Model):
	...
	usuario_registro = models.ForeignKey(User,related_name='empresa_agenda_usuario_registro')
	def __str__(self):
...
class Camion(models.Model):
	...
	estado_envio = models.ForeignKey(EstadoEnvio, blank=True, null=True)
	def __str__(self):
...
class HistorialContenedor(models.Model):
	contenedor = models.ForeignKey(Contenedor, blank=True, null=True)
	estado = models.ForeignKey(EstadoEnvio, blank=True, null=True)
	fecha = models.DateField(auto_now_add=True)
...
class Envio(models.Model):
	...
	quien_envia = models.ForeignKey(Cliente)
	quien_recibe = models.ForeignKey(ClienteRecibe, blank=True, null=True)
	...
	usuario_registro = models.ForeignKey(User)
	pais_destino = models.ForeignKey(Pais)
	departamento_destino = models.ForeignKey(Departamento)
	...
	revendedor_registro = models.ForeignKey(Revendedor,blank=True,null=True)
	...
	tipo_contenido = models.ForeignKey(TipoContenido,blank=True,null=True)
	tipo_envio = models.ForeignKey(TipoEnvio,blank=True,null=True)
	...
	fecha_cierre = models.DateField(auto_now_add=True)
	usuario_aprobo = models.ForeignKey(User,blank=True,null=True,related_name="usuario_aprobo")
	contenedor = models.ForeignKey(Contenedor,blank=True,null=True)
	camion = models.ForeignKey(Camion,blank=True,null=True)
...
class CajaPais(models.Model):
	...
	tipo_caja = models.ForeignKey(TipoCaja,blank=True,null=True)
...
class DetalleEnvio(models.Model):
	...
	tipo_caja = models.ForeignKey(CajaPais,blank=True,null=True)
	precio = models.FloatField(default=0.00)
...
class SeguimientoEnvio(models.Model):
	codigo_envio =  models.ForeignKey(Envio)
	estado = models.ForeignKey(EstadoEnvio)
	empresa = models.ForeignKey(Empresa, blank=True, null=True)
...
class EmpresaGasto(models.Model):
	tipo_gasto =  models.ForeignKey(EmpresaTipoGasto)
	empresa = models.ForeignKey(Empresa, null=True, blank=True)
	...
	usuario_registro = models.ForeignKey(User,related_name='empresa_gasto_usuario_registro')
	def __str__(self):
		return '{} | {}'.format(self.tipo_gasto, self.empresa)
...
class EmpresaDetalleCaja(models.Model):
	caja = models.ForeignKey(EmpresaControlCaja)
	cantidad = models.IntegerField(default=0)
	recibo_no = models.CharField(max_length=50,default='')
	...
	recibo_caja = models.ForeignKey(ReciboCaja, null=True, blank=True)
	usuario_registro = models.ForeignKey(User,related_name='detalle_caja_usuario_registro')
	def __str__(self):
...
class EmpresaMensaje(models.Model):
	tipo_mensaje = models.ForeignKey(TipoMensajes)
	envio = models.ForeignKey(Envio, blank=True, null=True)
...
class SistemaCliente(models.Model):
    ...
    usuario_registro = models.ForeignKey(AuthUser, models.DO_NOTHING)
    revenedor_creo = models.ForeignKey('SistemaRevendedor', models.DO_NOTHING, blank=True, null=True)
